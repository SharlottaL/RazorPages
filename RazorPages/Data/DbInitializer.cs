...
using RazorPages.Models;
    ...
    namespace ContosoUniversity.Data
    {
        ...
        {
            public static void Initialize(RazorPages.Data.RazorPagesContosoUniversityContext context)
            {
...
namespace ContosoUniversity.Data
{
    public static class DbInitializer
    {
        public static void Initialize(RazorPagesContosoUniversityContext context)
        {
            // Look for any students.
            if (context.Students.Any())
            {
